			...
			prompts    : [
				{
					...
					source : function ( answersSoFar,
						...
						return new Promise( function ( resolve ) {
							let entites = fs.readdirSync( `${ process.cwd() }/back/src/models` )
			...
			prompts    : [
				...
				},
				{
					...
					source : function ( answersSoFar,
						...
						fs.readdirSync( `${ process.cwd() }/back/src/models` )
						  .forEach( function ( file ) {
							  if ( file !== "index.js" && file !== "db.js" && file.replace(
								  ".model.js",
								  ""
							  ) !== firstEntityName ) {
								  entities.push( file.replace(
